  ...
  this.autorun(function () {
    ...
    Tracker.afterFlush(function () {
      ...
      if (_.has(data.atts, "readonly") && already_enabled) {
        ...
        /* when the set() will not trigger the autorun() below,
         * update materialnote's code here for the reinitialization
         * has cleared it.
         */
        if (already_enabled) $editor.code(self.value.get());
        else self.editor_enabled.set(true);
      }
    });
  });
